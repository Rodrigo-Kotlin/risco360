...
const sizeStyles: Record<ButtonSize, string> = {
  sm: 'h-8 px-3 text-label-medium gap-1.5 rounded-lg min-h-[48px]',
  md: 'h-10 px-4 text-label-large gap-2 rounded-xl min-h-[48px]',
  lg: 'h-12 px-6 text-title-medium gap-2 rounded-xl min-h-[48px]',
