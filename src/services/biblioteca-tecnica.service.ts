...
import * as mockService from './mock-biblioteca.service'

export async function listarItensBiblioteca(): Promise<ServiceResult<BibliotecaTecnicaItem[]>> {
  if (isMockModeEnabled) return mockService.listarBiblioteca()
  try {
...
export async function buscarItemBibliotecaPorId(
  ...
  if (isMockModeEnabled) return mockService.buscarBibliotecaItemPorId(id)
  try {
    const client = getClient()
...
export async function criarItemBiblioteca(
  ...
  if (isMockModeEnabled) return mockService.criarBibliotecaItem(input)
  try {
    const client = getClient()
...
export async function atualizarItemBiblioteca(
  ...
  if (isMockModeEnabled) return mockService.atualizarBibliotecaItem(id, input)
  try {
    const client = getClient()
...
export async function excluirItemBiblioteca(
  ...
  if (isMockModeEnabled) return mockService.excluirBibliotecaItem(id)
  try {
    const client = getClient()
